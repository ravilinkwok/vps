				    ...
				    <div class="card">
				    	<form action="{{ route('admin.departments.store') }}" method="POST">
						    ...
						    <div class="card-body">
						        ...
						        <div class="form-group">
						            <label>{{ __('levels.video_link') }}</label> <span class="text-danger">*</span>
						             <input type="text" name="video_link" class="form-control @error('video_link') is-invalid @enderror" value="{{ old('name') }}">
						            @error('status')
				                        <div class="invalid-feedback">
				                          	{{ $message }}
				                        </div>
