...
//            }
    ...
    {
        $role           = $role = Role::where('name','Admin')->first();
        $roleTow        = $role = Role::where('name','Reception')->first();
        ...
        return Datatables::of($userArray)
            ...
            ->addColumn('image', function ($user) {
                return '<img src="https://ui-avatars.com/api/?name='.$user->name.'&rounded=true&size=32" />';
